...
chcp 936 >nul 2>&1
title MAA 通知机器人 - 运行环境安装

echo.
echo +============================================+
echo   MAA 通知机器人 - 运行环境一键安装
...
echo   接下来请按照教程完成以下步骤:
echo.
echo   1. 编辑 config.yaml，填写 bot_qq / admin_qq
echo.
echo   2. 打开 MAA - 设置 - 远程控制，填入:
echo      任务获取端点: http://127.0.0.1:2345/maa/getTask
echo      任务汇报端点: http://127.0.0.1:2345/maa/reportStatus
echo.
